...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col overflow-hidden bg-gradient-to-b from-background to-secondary/20"
    >
      {/* Content Grid */}
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-52 pb-20 sm:pt-64 sm:pb-24">
